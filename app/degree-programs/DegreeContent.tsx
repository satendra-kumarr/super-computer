...
export default function DegreeContent() {
  ...
  return (
    <>
      <main className="pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 max-w-7xl mx-auto">
        ...
        <div className="flex gap-2 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-6 sm:mb-8 items-center">
        ...
        <FadeIn as="header" className="mb-12 sm:mb-16">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tighter text-[#181c20] mb-6 sm:mb-8 leading-[1.1] sm:leading-[1]">
              University <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#556500] to-[#b9d719]">Degrees</span>
            </h1>
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed font-medium max-w-xl mb-8 sm:mb-12">
            ...
            <div className="flex gap-2 w-full lg:w-auto overflow-x-auto pb-2 lg:pb-0 scrollbar-hide">
              {['All', 'Info Tech', 'Management', 'Education'].map(cat => (
                <button
                  ...
                  className={`px-5 py-3 sm:px-8 sm:py-4 rounded-xl text-[10px] sm:text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap ${selectedCategory === cat
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {filteredDegrees.length > 0 ? (
            filteredDegrees.map((degree) => (
              <FadeIn key={degree.id} className="group bg-white rounded-3xl sm:rounded-[2.5rem] border border-slate-100 p-6 sm:p-8 hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500 flex flex-col">
                <div className="h-48 sm:h-56 w-full rounded-2xl sm:rounded-[2rem] overflow-hidden mb-6 sm:mb-8 relative">
                  ...
                  <div className="absolute top-3 left-3 sm:top-4 sm:left-4 bg-[#181c20]/80 backdrop-blur-md px-3 py-1 sm:px-4 sm:py-1.5 rounded-full text-[9px] sm:text-[10px] font-bold text-[#b9d719] uppercase tracking-widest">
                    {degree.category}
                  </div>
                </div>
                <div className="flex-grow">
                  <div className="flex items-center gap-2 mb-3 sm:mb-4">
                    ...
                    <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-[#556500]">{degree.duration} Program</span>
                  </div>
                  <h3 className="text-xl sm:text-2xl font-black text-[#181c20] mb-4 sm:mb-6 leading-tight group-hover:text-[#556500] transition-colors">{degree.name}</h3>
                  <div className="space-y-3 sm:space-y-4 mb-8 sm:mb-10">
                    <div className="flex justify-between text-xs sm:text-sm py-2 border-b border-slate-50">
        ...
        <FadeIn as="section" className="mt-20 sm:mt-32 p-8 sm:p-12 lg:p-24 bg-slate-50 rounded-3xl sm:rounded-[4rem] border border-slate-100 flex flex-col lg:flex-row items-center gap-10 sm:gap-16 lg:gap-20">
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#181c20] tracking-tight mb-6 sm:mb-8">Launch Your Career with University Recognition</h2>
